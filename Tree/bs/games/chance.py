...
from summer_module.games.chance import Chance
...
class chance(commands):
    ...
    async def run(self):
        try:
            ...
            rep = Chance(self.mongo_manager, self.settings_info, int(self.from_id), int(self.date))
            ...
            if not result["error"]:
                ...
                slov = {
                    ...
                    perv[1]: {
                        ...
                        "chance": {
                            "🎯 Карты таро дали ответ на ваш вопрос. Да прибудет с вами таро.": random.randint(70, 99)
                        },
                        "sms": "🎯 Карты таро дали ответ на ваш вопрос. Да прибудет с вами таро."
                    },
                    perv[2]: {
                        "is_random": False,
                        "range": 4,
                    ...
                    perv[5]: {
                        ...
                        "chance": {
                            "🆘 Получил ошибку 404. Запускаю рандомайзер на основе ошибки": random.choice([54, 64, 74, 84, 94]),
                            "✅ Шанс получен, сайт не упал, я счастлив.": random.randint(55, 99),
                        },
                        "sms": random.choice(
                            ["🆘 Получил ошибку 404. Запускаю рандомайзер на основе ошибки",
                ...
                msg = messages_edit(self.v, self.club_id, self.apis, self.peer_id, ran, self.conversation_message_id)
