        ...
        try:
            ...
            if len(slov["peer_ids"]) > 0:
                ...
                res = await api_new.api_post("messages.send", v=self.v, peer_id=self.peer_id,
                                             message="😳 Так просто у нас разбан не получить...\n"
                                                     "🧩 Проходи квест и присылай подтверждение успешного завершения сюда в сообщения вместе с указанием бесееды, в которой получил бан:\n"
                                                     "🌐 https://joyteka.com/100026236",
...
automatic_unbans.keys = ['разбан4ае4е4ак', 'разбанитьукакуйакуа']
