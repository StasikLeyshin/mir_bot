    ...
    async def run(self):
        try:
            ...
            if await self.ls_open_check(self.from_id):
                ...
                user_info = MyTribe(self.mongo_manager, self.settings_info, self.from_id, self.date)
...
my_tribes.keys = ['/мой клан', '/клан', '/tribe', '/племя']
my_tribes.description = 'Мой трайб'
my_tribes.set_dictionary('my_tribe')
