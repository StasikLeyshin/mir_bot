...
from callback import executor_post
...
#             if event['type'] == "confirmation":
#                 return web.Response(text="3a7e0f66")
#             elif event['type'] == "message_new":
...
if __name__ == "__main__":
    ...
    #     loop_control[i["id"]] = i["them"]
        # if i["them"] == "tema1" or i["them"] == "zluka":
        #     callback_apis[i["id"]] = i["them"]
    ...
    #print(tasks)
    #     tasks.append(loop.create_task(tes()))
    ...
    #tasks.append(loop.create_task(inf.main_user(api(1, "vk1.a.y_smypVLUu0DX0g_Ob3wCwISwlYeQYvhPSlZwn47VQ8dUeKQEyKmHenM6_zigawvIM3RQ5uHS69BIyR_FqgfXqXIV1cAg8rtn62TYV1HJ3y5R31jO_FBAvtB0yOC8QE2x2-4nBXFDDQtv6n25in1Oe4xZFW7uHJznniKguIVfBTB6NLJMpozsiB3wjpn5yWJ"), 1)))
    #tasks.append(loop.create_task(inf.main_user(api(1, "vk1.a.4-wz_7ioSxz26js_mcoCXS6YtrXJ4z0gEpVNyMpN5kGhmlKYSVYKY35NC4OAA9iJqZroC9eLhb2ljp701YceQVcXHr8G6rVswAxV6lFIfUcEFAsRTO9IR81MnrRtEwiDtYIMyyJrCy8aXEUb4_pA61Cf2JCrUSMv7FglYPvKJ8SdkZPYfExidfqxTX8LZSaj"), 1)))
    tasks.append(loop.create_task(inf.main_user(apis[int(user_bot_id)], int(user_bot_id), mongo_manager=mongo_manager)))
    #tasks.append(test1())
