...
class api_error:
    ...
    async def error(self):
        ...
        if "error" in self.kwargs:
            ...
            logger.error(f'club_id: {self.club_id} | error_code: {self.kwargs["error"]["error_code"]} | {self.kwargs["error"]["error_msg"]} | method: {self.kwargs["error"]["request_params"][1]["value"]}')
